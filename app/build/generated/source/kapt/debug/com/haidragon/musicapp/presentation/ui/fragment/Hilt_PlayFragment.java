 ...
 */
public abstract class Hilt_PlayFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlayFragment_GeneratedInjector) this.generatedComponent()).injectPlayFragment(UnsafeCasts.<PlayFragment>unsafeCast(this));
    }
  }
