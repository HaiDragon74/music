 ...
 */
public abstract class Hilt_RecentSongFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecentSongFragment_GeneratedInjector) this.generatedComponent()).injectRecentSongFragment(UnsafeCasts.<RecentSongFragment>unsafeCast(this));
    }
  }
