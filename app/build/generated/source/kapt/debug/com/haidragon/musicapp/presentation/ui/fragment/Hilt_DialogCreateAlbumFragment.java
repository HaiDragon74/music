 ...
 */
public abstract class Hilt_DialogCreateAlbumFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DialogCreateAlbumFragment() {
    super();
  }

  Hilt_DialogCreateAlbumFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DialogCreateAlbumFragment_GeneratedInjector) this.generatedComponent()).injectDialogCreateAlbumFragment(UnsafeCasts.<DialogCreateAlbumFragment>unsafeCast(this));
    }
  }
