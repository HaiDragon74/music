 ...
 */
public abstract class Hilt_SongInAlbumFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SongInAlbumFragment_GeneratedInjector) this.generatedComponent()).injectSongInAlbumFragment(UnsafeCasts.<SongInAlbumFragment>unsafeCast(this));
    }
  }
