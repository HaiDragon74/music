 ...
 */
public abstract class Hilt_DiaLogSongBottomFragment<viewBinding extends ViewBinding> extends BaseBottomFragment<viewBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiaLogSongBottomFragment_GeneratedInjector) this.generatedComponent()).injectDiaLogSongBottomFragment(UnsafeCasts.<DiaLogSongBottomFragment>unsafeCast(this));
    }
  }
