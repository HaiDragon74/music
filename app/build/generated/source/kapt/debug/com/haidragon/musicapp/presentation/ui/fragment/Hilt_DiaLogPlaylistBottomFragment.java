 ...
 */
public abstract class Hilt_DiaLogPlaylistBottomFragment<viewBinding extends ViewBinding> extends BaseBottomFragment<viewBinding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiaLogPlaylistBottomFragment_GeneratedInjector) this.generatedComponent()).injectDiaLogPlaylistBottomFragment(UnsafeCasts.<DiaLogPlaylistBottomFragment>unsafeCast(this));
    }
  }
